...
export default function HeroSection() {
  return (
    <section className="bg-black/20 md:py-10 gap-8 md:px-20 p-8 flex md:flex-row flex-col items-center justify-center h-[500px] mt-28">
      <div className="md:w-1/2 flex flex-col items-start justify-center">
        ...
        <BoxReveal duration={1} boxColor="#ffffff60">
          <div className="text-background/80 dark:text-foreground/80 md:text-base text-sm">صدای آرام یک پلتفرم آنلاین است که به شما این امکان را می‌دهد، به راحتی و با کیفیت بالا، صداهای آرامش‌بخش را بشنوید و تجربه‌ای منحصر به فرد از آرامش را داشته باشید.
          از صداهای آرامش بخش استفاده کنید تا روز آرام و بدون استرسی رو برای خودتون بسازین.
          </div>
        </BoxReveal>
      </div>

      <div className="md:w-1/2 w-full relative flex items-center justify-center md:aspect-square aspect-[2/1]">
        <svg className="absolute md:w-full md:h-full w-[250px] h-[250px] md:p-10 p-4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path
            fill="#F2F4F8"
